...
nohup python3 launch.py --dataset mimic --model shared --pruning sparse_learning --encode_time_dim False --device "cuda" > ./logs/sparse_learning/mimic_shared_sparse_learning2.log 2>&1 &
nohup python3 launch.py --dataset mimic --model atomics --pruning sparse_learning --use_summaries_for_atomics False --device "cuda" > ./logs/sparse_learning/mimic_atomics_sparse_learning2.log 2>&1 &
...
nohup python3 launch.py --dataset tiselac --model shared --pruning sparse_learning --encode_time_dim False --device "cuda:1" > ./logs/sparse_learning/tiselac_shared_sparse_learning2.log 2>&1 &
nohup python3 launch.py --dataset tiselac --model atomics --pruning sparse_learning --use_summaries_for_atomics False --device "cuda:1" > ./logs/sparse_learning/tiselac_atomics_sparse_learning2.log 2>&1 &
...
nohup python3 launch.py --dataset spoken_arabic_digits --model shared --pruning sparse_learning --encode_time_dim False --device "cuda:2" > ./logs/sparse_learning/spoken_arabic_digits_shared_sparse_learning2.log 2>&1 &
nohup python3 launch.py --dataset spoken_arabic_digits --model atomics --pruning sparse_learning --use_summaries_for_atomics False --device "cuda:2" > ./logs/sparse_learning/spoken_arabic_digits_atomics_sparse_learning2.log 2>&1 &
